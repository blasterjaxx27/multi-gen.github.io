...
if (strpos($_SERVER['HTTP_REFERER'], $_SERVER['HTTP_HOST'].'/captcha') != (7 OR 8)) {
    header('Location: /');
    exit();
}
        ...
        <div class="col-lg-4">
            <div class="text-center">
                ...
                <form method="POST" action="/">
                    <button type="submit" value="<?=htmlspecialchars($_GET['idgen']) ?>" name="generer" class="btn btn-primary m-3"><i class="mdi mdi-backburger"></i> Générer un nouveau compte</button>
                </form>
            </div>
        </div>
    </div>
