                ...
                <div class="col-md-4">
                    <div class="card card-pricing">
                        <div class="card-body text-center">
                            ...
                            <a href="https://manager.freegen.xyz/pay/starter" class="btn btn-primary mt-4 mb-2 btn-rounded">Acheter</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card card-pricing card-pricing-recommended">
                        <div class="card-body text-center">
                            ...
                            <a href="https://manager.freegen.xyz/pay/pro" class="btn btn-primary mt-4 mb-2 btn-rounded">Acheter</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card card-pricing">
                        <div class="card-body text-center">
                            ...
                            <a href="https://manager.freegen.xyz/pay/giant" class="btn btn-primary mt-4 mb-2 btn-rounded">Acheter</a>
                        </div>
                    </div>
                </div>
            </div>
